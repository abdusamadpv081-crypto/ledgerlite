...
| Operator provisioning role  | Can write immutable assisted-pilot provisioning evidence and temporarily assume the API role inside the reviewed provisioning command. |
