...
| P1       | Add a migration runner/applied-migration ledger and previous-version upgrade test.                                                                | CI validates empty and upgrade database paths.                                  |
...
| P1       | Add CodeQL and configure GitHub required checks, push protection, and branch protection.                                                          | Security checks appear on pull requests.                                        |
